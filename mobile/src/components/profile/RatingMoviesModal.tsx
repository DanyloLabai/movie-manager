...
export default function RatingMoviesModal({
  rating,
  onClose,
  onPressMovie,
}: RatingMoviesModalProps) {
  ...
  useEffect(() => {
    ...
    getWatched(PAGE_SIZE, 0, rating)
      ...
      .catch(logError("RatingMoviesModal: getWatched"))
                ...
                hasMore ? (
                  ...
                  >
                    <Text style={styles.loadMoreText}>
                      {isLoadingMore
                        ? "…"
                        : t("ratingModal.loadMore").toUpperCase()}
                    </Text>
                  </Pressable>
                ) : null
              }
