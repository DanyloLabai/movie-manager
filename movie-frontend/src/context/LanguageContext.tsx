...
const translations = {
  en: {
    ...
    quiz_friends_today: "Friends today",
    quiz_friend_solved: "solved in",
    quiz_friend_failed: "failed",
  ...
  uk: {
    ...
    quiz_difficulty_easy: "Легко",
    quiz_difficulty_normal: "Нормально",
    quiz_difficulty_hard: "Важко",
    quiz_attempts_left: "Спроб залишилось",
    ...
    quiz_friends_today: "Друзі сьогодні",
