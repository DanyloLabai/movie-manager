...
const translations = {
  en: {
    ...
    auth_required_message: "Create an account or log in to continue.",
    auth_required_login: "Log in",
    auth_required_register: "Sign up",
    sidebar_guest_name: "Guest",
    feedback_title: "How are we doing?",
    feedback_subtitle: "Rate the app and leave a comment if you'd like.",
    feedback_placeholder: "What could be better? (optional)",
    feedback_submit: "Send feedback",
    feedback_sending: "Sending...",
    feedback_skip: "Not now",
    feedback_thanks: "Thanks for the feedback!",
    feedback_error: "Couldn't send feedback. Try again later.",
    ...
    quiz_hints_opened_after_finish: "all opened after finishing",
    quiz_leaderboard_today: "this month",
    quiz_result_correct: "Correct",
    quiz_result_failed: "Failed",
    quiz_next_movie_tomorrow: "next movie- tomorrow",
    quiz_guessed_headline: "Guessed!",
    quiz_not_guessed_headline: "Not this time",
    quiz_your_answer_label: "Your answer:",
    quiz_correct_answer_label: "The answer was:",
    quiz_attempts_used_label: "Attempts used",
    quiz_hints_used_label: "Hints used",
    quiz_add_watchlist_btn: "+ Watchlist",
    quiz_new_movie_in_label: "New movie in",
    quiz_share_result_link: "Share result →",
    quiz_share_copied: "Result copied to clipboard.",
    quiz_watchlist_error: "Couldn't add to watchlist.",
    quiz_solved_caption: "guessed",
    quiz_tries_label: "tries",
    ...
    chat_usage_photo_label: "Photo IDs",
    chat_usage_photo: "[USED]/[LIMIT] photo IDs today",
    ...
    chat_photo_placeholder: "Add a note about the photo (optional)...",
    chat_photo_attached_hint: "Photo attached- add a note or hit send",
    chat_photo_remove_title: "Remove photo",
    chat_no_posters:
    ...
    search_trending_tv: "Trending TV Series",
    search_coming_soon: "Coming Soon",
    search_coming_soon_movies: "Coming Soon Movies",
    search_coming_soon_tv: "Coming Soon TV Series",
    search_hot: "HOT",
    search_new: "NEW",
    ...
    journey_section_title: "Your Journey",
    journey_you_are_here: "You",
    journey_locked_name: "???",
    journey_unlocked: "✓ Unlocked",
    journey_one_movie_to_go: "movie to go",
    journey_movies_to_go: "movies to go",
    ...
    journey_someone_title: "{name}'s Journey",
    journey_unlocked_at: "✓ Unlocked at {count} movies",
    journey_unlocked_at_one: "✓ Unlocked at 1 movie",

    journey_stop_shire: "The Shire",
    journey_stop_hobbiton: "Hobbiton",
    journey_stop_buckland: "Buckland",
    journey_stop_old_forest: "The Old Forest",
    journey_stop_bree: "Bree",
    journey_stop_weathertop: "Weathertop",
    journey_stop_fords_of_bruinen: "Fords of Bruinen",
    journey_stop_rivendell: "Rivendell",
    journey_stop_caradhras: "Caradhras",
    journey_stop_moria: "Mines of Moria",
    journey_stop_lothlorien: "Lothlorien",
    journey_stop_anduin: "The Anduin River",
    journey_stop_amon_hen: "Amon Hen",
    journey_stop_emyn_muil: "Emyn Muil",
    journey_stop_dead_marshes: "The Dead Marshes",
    journey_stop_black_gate: "The Black Gate",
    journey_stop_ithilien: "Ithilien",
    journey_stop_cirith_ungol: "Cirith Ungol",
    journey_stop_gorgoroth: "Plateau of Gorgoroth",
    journey_stop_mount_doom: "Mount Doom",
    ...
    movie_rewatch: "Rewatch",
    movie_rewatch_desc: "Logging a rewatch of",
    movie_rewatch_logged: "Rewatch logged!",
    movie_rating_history: "Rating history",
    movie_rewatch_count: "Rewatched {count}x",
    ...
    quiz_stats_title: "[username]'s Quiz Stats",
    quiz_stats_avg_score: "Avg Score",
    quiz_stats_solved: "Solved",
    quiz_stats_perfect: "Perfect",
    quiz_stats_total_score: "Month Total",
    ...
    profile_someones_friends: "{name}'s Friends",
    ...
    compat_daily_limit:
      "You've used all 3 taste-match tries for today. Come back tomorrow for new picks!",
    compat_tries_hint: "3 tries per day",
    ...
    discover_today: "today",
    discover_loading: "Finding movies for you…",
    discover_load_error: "Couldn't load today's picks.",
    discover_retry: "Retry",
    discover_badge_for_you: "For you",
    discover_badge_different: "Something different",
    discover_details: "Details",
    discover_min: "min",
    discover_skip: "Skip",
    discover_skip_key: "← Skip",
    discover_watched: "Watched",
    discover_watched_key: "Watched · W",
    discover_watchlist: "Watchlist",
    discover_watchlist_key: "To watchlist →",
    discover_rate_label: "Mark as watched",
    discover_rate_confirm: "Confirm",
    discover_rate_cancel: "Cancel",
    discover_done_title: "That's all for today",
    discover_done_subtitle:
      "You've been through today's picks. New recommendations tomorrow- or rate a few more movies to sharpen your taste profile.",
    discover_done_watchlist: "My watchlist",
    discover_done_quiz: "Play daily quiz",
    discover_next_batch: "New batch in",
    discover_entry_label: "Discover",
    discover_promo_title: "Not sure what to watch?",
    discover_promo_swipe: "Swipe today's picks",
    discover_promo_of: "of",
  ...
  uk: {
    ...
    auth_required_title: "Потрібен вхід",
    auth_required_message: "Зареєструйтесь або увійдіть, щоб продовжити.",
    auth_required_login: "Увійти",
    auth_required_register: "Зареєструватися",
    sidebar_guest_name: "Гість",
    feedback_title: "Як вам застосунок?",
    feedback_subtitle: "Оціни нас і за бажанням залиш коментар.",
    feedback_placeholder: "Що можна покращити? (необов'язково)",
    feedback_submit: "Надіслати відгук",
    feedback_sending: "Надсилаємо...",
    feedback_skip: "Не зараз",
    feedback_thanks: "Дякуємо за відгук!",
    feedback_error: "Не вдалося надіслати відгук. Спробуй пізніше.",
    quiz_title: "Квіз дня",
    quiz_subtitle:
    ...
    quiz_hints_opened_after_finish: "усі відкрито після завершення",
    quiz_leaderboard_today: "цього місяця",
    quiz_result_correct: "Вгадано",
    quiz_result_failed: "Не вгадано",
    quiz_next_movie_tomorrow: "наступний фільм- завтра",
    quiz_guessed_headline: "Вгадано!",
    quiz_not_guessed_headline: "Не цього разу",
    quiz_your_answer_label: "Твоя відповідь:",
    quiz_correct_answer_label: "Правильна відповідь:",
    quiz_attempts_used_label: "Спроб використано",
    quiz_hints_used_label: "Підказок відкрито",
    quiz_add_watchlist_btn: "+ У список",
    quiz_new_movie_in_label: "Новий фільм через",
    quiz_share_result_link: "Поділитись результатом →",
    quiz_share_copied: "Результат скопійовано.",
    quiz_watchlist_error: "Не вдалося додати до списку.",
    quiz_solved_caption: "вгадано",
    quiz_tries_label: "спроб",
    ...
    chat_usage_photo_label: "Розпізнавання фото",
    chat_usage_photo: "[USED]/[LIMIT] розпізнавань фото сьогодні",
    ...
    chat_photo_placeholder: "Додай коментар до фото (необов'язково)...",
    chat_photo_attached_hint: "Фото додано- напиши коментар або надішли",
    chat_photo_remove_title: "Прибрати фото",
    chat_no_posters:
    ...
    search_trending_movies: "У тренді: фільми",
    search_trending_tv: "У тренді: серіали",
    search_coming_soon: "Скоро на екранах",
    search_coming_soon_movies: "Скоро на екранах: фільми",
    search_coming_soon_tv: "Скоро на екранах: серіали",
    search_hot: "ТОП",
    search_new: "НОВЕ",
    ...
    journey_section_title: "Твоя подорож",
    journey_you_are_here: "Ти",
    journey_locked_name: "???",
    journey_unlocked: "✓ Відкрито",
    journey_one_movie_to_go: "фільм до розблокування",
    journey_movies_to_go: "фільмів до розблокування",
    ...
    journey_unlocked_at: "✓ Розблоковано при {count} фільмах",
    journey_unlocked_at_one: "✓ Розблоковано при 1 фільмі",

    journey_stop_shire: "Шир",
    journey_stop_hobbiton: "Гобітон",
    journey_stop_buckland: "Бакленд",
    journey_stop_old_forest: "Старий Ліс",
    journey_stop_bree: "Брі",
    journey_stop_weathertop: "Заверть",
    journey_stop_fords_of_bruinen: "Броди Бруїнена",
    journey_stop_rivendell: "Рівендел",
    journey_stop_caradhras: "Карадрас",
    journey_stop_moria: "Копальні Морії",
    journey_stop_lothlorien: "Лотлорієн",
    journey_stop_anduin: "Ріка Андуїн",
    journey_stop_amon_hen: "Амон Хен",
    journey_stop_emyn_muil: "Емін Мьюл",
    journey_stop_dead_marshes: "Мертві Драговини",
    journey_stop_black_gate: "Чорна Брама",
    journey_stop_ithilien: "Ітілієн",
    journey_stop_cirith_ungol: "Кіріт Унгол",
    journey_stop_gorgoroth: "Плато Горгорот",
    journey_stop_mount_doom: "Гора Приречення",
    ...
    movie_rewatch: "Передивитись",
    movie_rewatch_desc: "Позначаєш повторний перегляд",
    movie_rewatch_logged: "Повторний перегляд збережено!",
    movie_rating_history: "Історія оцінок",
    movie_rewatch_count: "Передивились {count}x",
    ...
    quiz_stats_title: "Квіз-статистика [username]",
    quiz_stats_avg_score: "Серед. рахунок",
    quiz_stats_solved: "Розгадано",
    quiz_stats_perfect: "Ідеально",
    quiz_stats_total_score: "Разом за місяць",
    ...
    profile_someones_friends: "Друзі {name}",
    ...
    feed_rewatched: "передивився(-лась)",
    time_just_now: "щойно",
    ...
    compat_daily_limit:
      "Ти використав усі 3 спроби збігу смаків на сьогодні. Повертайся завтра за новими варіантами!",
    compat_tries_hint: "3 спроби на день",
    ...
    discover_today: "сьогодні",
    discover_loading: "Підбираємо фільми…",
    discover_load_error: "Не вдалося завантажити сьогоднішні підбірки.",
    discover_retry: "Повторити",
    discover_badge_for_you: "For you",
    discover_badge_different: "Something different",
    discover_details: "Деталі",
    discover_min: "хв",
    discover_skip: "Skip",
    discover_skip_key: "← Пропустити",
    discover_watched: "Watched",
    discover_watched_key: "Watched · W",
    discover_watchlist: "Watchlist",
    discover_watchlist_key: "У watchlist →",
    discover_rate_label: "Позначити переглянутим",
    discover_rate_confirm: "Підтвердити",
    discover_rate_cancel: "Скасувати",
    discover_done_title: "Це все на сьогодні",
    discover_done_subtitle:
      "Ти переглянув усі підбірки на сьогодні. Нові рекомендації- завтра, або оціни ще кілька фільмів, щоб покращити підбірку.",
    discover_done_watchlist: "Мій watchlist",
    discover_done_quiz: "Зіграти в квіз дня",
    discover_next_batch: "Нова пачка через",
    discover_entry_label: "Discover",
    discover_promo_title: "Не знаєш, що подивитись?",
    discover_promo_swipe: "Свайпай сьогоднішню підбірку",
    discover_promo_of: "із",
    discover_promo_remaining: "лишилось",
  },
} as const;
