  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-sm font-black text-[#f0e6cc] uppercase tracking-widest mb-1 pr-8">
          {formatted}
        </h2>
        <p className="text-[10px] text-[#c8963c] font-bold uppercase tracking-widest mb-4">
        ...
        <div className="flex flex-col gap-1.5 max-h-[50vh] overflow-y-auto pr-1">
          {day.actions.map((action, i) => (
            <Link
              ...
              onClick={onClose}
              className="flex items-center gap-2.5 bg-[#12100e] p-2 rounded-xl border border-[#c8963c]/10 hover:border-[#c8963c]/40 transition group"
            >
              ...
              <div className="flex flex-col overflow-hidden min-w-0">
                ...
                <span className="text-[9px] text-[#f0e6cc]/50 flex items-center gap-1">
